    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                        <a href="{{route('tenderadmin.add')}}" class="btn btn-primary">Add</a>
                    <div class="form-group">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{$tender->title}}</td>
                                <td>
                                    <a href="{{route('tenderadmin.edit',$tender->title)}}">
                                    ...
                                    <div class="modal fade" id="modal-deleteMember">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST" action="{{route('tenderadmin.destroy',$tender->id)}}">
                                                    @csrf
                                                    @method('DELETE')
