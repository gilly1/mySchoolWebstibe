        ...
        <section class="content container-fluid">
            ...
            <div class="modal fade" id="modal-addMember">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                         <!--BOARD-->
                        <h3>{{__('School Heads') }}</h3>
                        <form method="POST" action="{{ route('schbossimg.store') }}" enctype="multipart/form-data" aria-label="{{ __('Save changes') }}">
                            @csrf
                                <div class="form-group">
                                    <label for="schbossimgname">Name</label>
                                    <input type="text" class="form-control" id="schbossimgname" placeholder="Name" name="name">
                                </div>
                                <div class="form-group">
                                    <label for="schbossimgDesc">Description</label>
                                    <input type="text" class="form-control" id="schbossimgDesc" placeholder="Description" name="description">
                                </div>
                                <div class="form-group">
                                    <label>Rank</label>
                                    <select class="form-control" name="rank">
                                        <option selected disabled="disabled">Choose...</option>
                                        <option value="chairman">Principal</option>
                                        <option value="vice-chair">D-Principal</option>
                                        <option value="secretary">SeniorTeacher</option>
                                    </select>
                                </div>
                                <div class="form-group">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">{{__('School Heads') }}</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body no-padding">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('schbossimg.edit',$member->id)}}">
                                ...
                                <div class="modal fade" id="modal-deleteMember">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="{{route('schbossimg.destroy',$member->id)}}">
                                                @csrf
                                                @method('DELETE')
