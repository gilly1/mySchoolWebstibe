        ...
        <section class="content container-fluid">
            ...
            <div class="modal fade" id="modal-addMember">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                         <!--Teachers-->
                        <h3>Teaching Staff Members</h3>
                        <form method="POST" action="{{ route('teachers.store') }}" enctype="multipart/form-data" aria-label="{{ __('Save changes') }}">
                            @csrf
                                <div class="form-group">
                                    <label for="teachersname">Name</label>
                                    <input type="text" class="form-control" id="teachersname" placeholder="Name" name="name">
                                </div>
                                <div class="form-group">
                                    <label for="teachersDesc">Description</label>
                                    <input type="text" class="form-control" id="teachersDesc" placeholder="Description" name="description">
                                </div>
                                <div class="form-group">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">{{__('Teaching staff Staff') }}</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body no-padding">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('teachers.edit',$member->id)}}">
                                ...
                                <div class="modal fade" id="modal-deleteMember">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="{{route('teachers.destroy',$member->id)}}">
                                                @csrf
                                                @method('DELETE')
