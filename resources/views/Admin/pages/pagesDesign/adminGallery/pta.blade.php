            ...
            <div class="modal fade" id="modal-addMember">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                         <!--PTA-->
                        <h3>PTA Members</h3>
                        <form method="POST" action="{{ route('pta.store') }}" enctype="multipart/form-data" aria-label="{{ __('Save changes') }}">
                            @csrf
                                <div class="form-group">
                                    <label for="ptaname">Name</label>
                                    <input type="text" class="form-control" id="ptaname" placeholder="Name" name="name">
                                </div>
                                <div class="form-group">
                                    <label for="ptaDesc">Description</label>
                                    <input type="text" class="form-control" id="ptaDesc" placeholder="Description" name="description">
                                </div>
                                <div class="form-group">
                                    <label>Rank</label>
                ...
                <div class="box-body no-padding">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('pta.edit',$member->id)}}">
                                ...
                                <div class="modal fade" id="modal-deleteMember">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="{{route('pta.destroy',$member->id)}}">
                                                @csrf
                                                @method('DELETE')
