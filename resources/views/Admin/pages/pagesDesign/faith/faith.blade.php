    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                        <a href="{{route('faithadmin.add')}}" class="btn btn-primary">Add</a>
                    <div class="form-group">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{$page->link}}</td>
                                <td>
                                    <a href="{{route('faithadmin.edit',$page->link)}}">
                                    ...
                                    <div class="modal fade" id="modal-deleteMember">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form method="POST" action="{{route('faithadmin.destroy',$page->link)}}">
                                                    @csrf
                                                    @method('DELETE')
