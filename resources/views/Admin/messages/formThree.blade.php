        ...
        <section class="content container-fluid">
            ...
            <div class="modal fade" id="modal-addMember">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                         <!--BOARD-->
                        <h3>New Number</h3>
                        <form method="POST" action="{{ route('formThree.store') }}" aria-label="{{ __('Save changes') }}">
                            @csrf
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">{{__('Numbers for Form Three Parents') }}</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body no-padding">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>{{$member->name}}</td>
                            <td>
                                <a href="{{route('formThree.edit',$member->id)}}">
                                ...
                                <div class="modal fade" id="modal-deleteMember">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="{{route('formThree.destroy',$member->id)}}">
                                                @csrf
                                                @method('DELETE')
