            ...
            <div class="modal fade" id="modal-addMember">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                         <!--BOARD-->
                        <h3>New Number</h3>
                        <form method="POST" action="{{ route('formOne.store') }}" aria-label="{{ __('Save changes') }}">
                            @csrf
                ...
                <div class="box-body no-padding">
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>{{$member->name}}</td>
                            <td>
                                <a href="{{route('formOne.edit',$member->id)}}">
                                ...
                                <div class="modal fade" id="modal-deleteMember">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form method="POST" action="{{route('formOne.destroy',$member->id)}}">
                                                @csrf
                                                @method('DELETE')
